...
public class CreateMachineEventListenerTest {
    ...
    @InjectMocks
    private CreateMachineEventListener listener;
    ...
    @Test
    public void shouldAddNewMachineIntoWorkspaceRuntime() throws ConflictException, NotFoundException {
        listener.onEvent(event);

        verify(workspaceRuntimes).addMachineIntoRuntime(eq(WORKSPACE_ID), eq(machine));
    }

    @Test
    public void shouldNotAddDevMachineIntoWorkspaceRuntimeList() throws ConflictException, NotFoundException {
        when(event.isDev()).thenReturn(true);

        verify(workspaceRuntimes, never()).addMachineIntoRuntime(anyString(), anyObject());
    }

    @Test
    public void shouldNotAddMachineIfItsStatusIsRunning() throws ConflictException, NotFoundException {
    ...
    @Test
    public void shouldNotAddMachineIfItsStatusIsDestroying() throws ConflictException, NotFoundException {
    ...
    @Test
    public void shouldNotAddMachineIfItsStatusIsDESTROYED() throws ConflictException, NotFoundException {
    ...
    @Test
    public void shouldNotAddMachineIfItsStatusIsERROR() throws ConflictException, NotFoundException {
