...
public class WsMasterModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(org.eclipse.che.api.workspace.server.event.DestroyedMachineEventListener.class).asEagerSingleton();
        bind(org.eclipse.che.api.workspace.server.event.CreateMachineEventListener.class).asEagerSingleton();
